...
const (
	ChatService_Create_FullMethodName      = "/ChatService/Create"
	ChatService_Delete_FullMethodName      = "/ChatService/Delete"
...
func (UnimplementedChatServiceServer) Delete(context.Context, *DeleteRequest) (*DeleteResponse, error) {
